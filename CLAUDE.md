...
- **Website figures** → `assets/figures/publication/` — warm cream background (`#f7f4ee`), dark ink, site-matching color palette
- **arXiv figures** → `arxiv/figures/` — white background (`#ffffff`), high-contrast black ink, print-ready
